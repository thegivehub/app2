        ...
        >
            <Container>
                <Stack>
                    ...
                    />
                    <Paper {...paperProps}>
                        <Text fw={500}>Tip The Give Hub services</Text>
                        <Text size="sm" my="xs">The Give Hub has a 0% platform fee for organizers. The Give Hub will continue
                    ...
                    <Paper {...paperProps}>
                        <Stack>
                            <Text size="sm">By continuing, you agree with <Anchor>The Give Hub terms</Anchor> and <Anchor>privacy
                                notice.</Anchor></Text>
                            ...
                            <Flex gap="sm">
                                ...
                                <Text size="sm">We guarantee you a full refund for up to a year in the rare case that
                                    fraud occurs.&nbsp;<Anchor>See our The Give Hub Giving Guarantee.</Anchor>
                                </Text>
                            </Flex>
                        </Stack>
                    </Paper>
